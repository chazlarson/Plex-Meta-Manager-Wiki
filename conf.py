...
html_theme_options = {
    ...
    # Render the site's TOC in the navbar. (Default: true)
    'navbar_sitenav': False,
    ...
    'navbar_links': [
        ("_menu", "Essentials", [
            ...
            ("_menu", "Installation", [
                ...
                ("_divider", ),
                ("Local Walk-through", "home/guides/local"),
                ("Docker Walk-through", "home/guides/docker"),
                ("unRAID Walk-through", "home/guides/unraid"),
                ("Kubernetes Walk-through", "home/guides/kubernetes"),
            ]),
